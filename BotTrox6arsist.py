...
import BOTTROX
from BOTTROX.lib.curve.ttypes import *
...
kt = BOTTROX.LINE()
kt.login(token="Eqt4hxAsQtv5a4lG4Pb2.o8LSrfCelHJhhggYpY3ECG.89tTjn7ar5yjjSmJ264c867m9A4BWxxm3qA6WDPfuQ0=")
kt.loginResult()

ks = BOTTROX.LINE()
ks.login(token="EqsBVdQi8OKTh3j6Mkx5.hSHvpJH1bE2GB8InsSg0vq.2ssZtwAkffmtOy9zrJCx0F8Gz1oV17cMQqtHU3B6fYY=")
ks.loginResult()

ki = BOTTROX.LINE()
ki.login(token="EqCQV4Xbt7fHlhYgUBud.nI0+pkrzsIaJT928xZbUBq.AzE6+ebi0x+XnVazhYcPu9R9Fi+PKs9CKCKa4nAEA3Q=")
ki.loginResult()

kk = BOTTROX.LINE()
kk.login(token="Eqixl8C941Gv5hRQQ1Oa.VSkC4kWnVqaJsixjMKNE/G.LZcRDlgubJxkwt6wssjfeXlOWiPDOhW6mUGoHlZK9mE=")
kk.loginResult()

kc = BOTTROX.LINE()
kc.login(token="Eq8a1kGdhzncFNclSwE8.aWOMtct5v8ZYoiURB63+6a.uXYoZThrYy/BE6ZtIYDK/P8fmAI7+yWy2PPsJ25a4Os=")
kc.loginResult()

kl = BOTTROX.LINE()
kl.login(token="EqinhCtJYhf2qsldL9Q8.jyCu5B2qelpygXkvspNkYa.clyuM1pLjwH/fW2K5peDhb5lO85xQ/Sy41aQMC4eUfc=")
kl.loginResult()

print "Login sucses Trox"
reload(sys)
...
╠ Link :  http://line.me/ti/p/up3NLjmK17
╠ 
╚═══════════════════
"""
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u1608ae21e5de2547b5fa8707b21ca220"]
